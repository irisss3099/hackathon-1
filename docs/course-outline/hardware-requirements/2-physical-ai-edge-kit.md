...
### The Eyes (Vision): Intel RealSense
...
### The Inner Ear (Balance): IMU
-   **Model**: Generic USB IMU (BNO055).
-   **Note**: Often built into the RealSense D435i or Jetson boards, but a separate module helps teach IMU calibration.

### Voice Interface
-   **Model**: A simple USB Microphone/Speaker array (e.g., ReSpeaker).
-   **Role**: Used for the "Voice-to-Action" Whisper integration.
