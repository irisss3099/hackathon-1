...
### GPU (The Bottleneck)
-   **Specification**: NVIDIA RTX 4070 Ti (12GB VRAM) or higher.
...
### CPU
-   **Specification**: Intel Core i7 (13th Gen+) or AMD Ryzen 9.
-   **Why**: Physics calculations (Rigid Body Dynamics) in Gazebo/Isaac are CPU-intensive.

### RAM
-   **Specification**: 64 GB DDR5 (32 GB is the absolute minimum, but will crash during complex scene rendering).
